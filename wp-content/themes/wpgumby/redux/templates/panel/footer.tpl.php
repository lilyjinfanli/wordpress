...
<?php 
            ...
            if ( false === $this->parent->args['hide_reset'] ) {
                submit_button( __( 'Reset Section', 'wpgumby' ), 'secondary', $this->parent->args['opt_name'] . '[defaults-section]', false, array( 'id' => 'redux-defaults-section' ) );
                submit_button( __( 'Reset All', 'wpgumby' ), 'secondary', $this->parent->args['opt_name'] . '[defaults]', false, array( 'id' => 'redux-defaults' ) );
            } 
?>
        </div>

        <div class="redux-ajax-loading" alt="<?php _e( 'Working...', 'wpgumby' ) ?>">&nbsp;</div>
        <div class="clear"></div>
